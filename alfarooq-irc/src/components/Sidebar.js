...
function Item({ href, icon: Icon, label, onClick }) {
  return (
    <Link
      ...
      dir="rtl"
      onClick={onClick}
      className="flex items-center justify-between py-3 px-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition"
    >
...
export default function Sidebar() {
  ...
  /* The same list used for both desktop rail and mobile drawer */
  const list = (closeDrawer) => (
    <>
  ...
  return (
    <>
      ...
      <aside
        dir="rtl"
        className="hidden md:flex flex-col fixed top-20 font-arabic right-0 h-screen w-56 border-l border-gray-200 dark:border-gray-800 bg-white dark:bg-[#101827] z-40"
      >
        {list()}
      </aside>
